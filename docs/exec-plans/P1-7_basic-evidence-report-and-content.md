...
After separate approval, implement source collection, deterministic validator, evaluator-neutral proposal contract, deterministic/fake evaluator, basic semantic report generation, completeness and failure/re-entry behavior. It does not implement formal P3 scoring, a real-provider requirement, REST/Web or question authoring.
