...
- Current status: P1-2 DONE；P1-3 IN_PROGRESS；P1-3A completed docs-only；P1-3B awaiting explicit approval
...
- P1-3A：completed；state/timing design consumes immutable question-version binding without changing question/persona schema；P1-3B awaiting explicit approval；
